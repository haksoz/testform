...
--
-- Host: 127.0.0.1    Database: testform_db
-- ------------------------------------------------------
...
INSERT INTO `settings` VALUES (1,'form_title','Test Form - Kayit Formu','2025-12-25 20:27:17');
...
LOCK TABLES `test_form` WRITE;
/*!40000 ALTER TABLE `test_form` DISABLE KEYS */;
INSERT INTO `test_form` VALUES (1,'Hasan','Can','2025-12-25 20:21:49');
/*!40000 ALTER TABLE `test_form` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'testform_db'
--
...
-- Dump completed on 2025-12-27 21:14:48
